...
export function useToast() {
  ...
  /* createPortal ke document.body -- alasan sama seperti ConfirmDialog di
     useConfirm.tsx: toast ini "fixed", tapi kalau kepanggil di halaman
     yang Table-nya dibungkus div ".card" (Pengaturan/Laporan/Pelanggan),
     .card punya backdrop-filter yang bikin posisi fixed-nya kejebak di
     dalam kotak .card itu, bukan di atas seluruh layar. */
  const ToastBanner =
    toast &&
    createPortal(
