...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-white p-4 md:p-6">
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-7xl overflow-hidden rounded-[32px] border border-blue-200 bg-white dark:bg-gray-800 shadow-2xl">
        {/* Left - Form */}
        <div className="flex w-full flex-col justify-center px-6 py-12 md:w-1/2 md:px-12 lg:px-16">
          <div className="mb-6 flex items-center gap-3 md:hidden">
            <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl border border-blue-200 bg-white dark:bg-gray-800 shadow">
              <Image
            ...
            <div>
              <p className="font-display text-sm font-bold text-black dark:text-white">DJOGKER</p>
              <p className="text-[10px] tracking-widest text-gray-500 dark:text-gray-400">SCM SYSTEM</p>
            </div>
          </div>

          <h1 className="mb-2 text-3xl font-bold text-black dark:text-white md:text-4xl font-display">
            Selamat Datang!
          </h1>
        ...
        <div className="relative hidden w-1/2 items-center justify-center overflow-hidden bg-gradient-to-br from-blue-100 via-blue-50 to-white md:flex">
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 px-10 text-center">
            <div className="relative flex h-80 w-80 items-center justify-center overflow-hidden rounded-full border border-blue-200 bg-white dark:bg-gray-800 shadow-2xl shadow-blue-200/50">
              <Image
            ...
            <div>
              <h2 className="font-display text-3xl font-bold tracking-[0.15em] text-black dark:text-white">
                DJOGKER
              </h2>
