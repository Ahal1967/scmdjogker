...
export default function EditProfilePage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="font-display font-bold text-xl">Edit Profil</h1>
      ...
      <div className="card max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs text-djoker-muted mb-1.5 block">ID User</label>
            <input
              type="text"
              value={formData.id}
              disabled
              className="input-field bg-gray-500/10 text-djoker-muted"
            />
