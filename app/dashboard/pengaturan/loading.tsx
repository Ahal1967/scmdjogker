/* Skeleton loading khusus halaman Pengaturan (header + tabel pengguna,
   tanpa kartu ringkasan) -- lihat komentar di gudang/loading.tsx untuk
   alasannya. */
  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-pulse" aria-hidden="true">
      ...
      <div className="card p-0 overflow-hidden">
        <div className="h-14 border-b border-gray-100 dark:border-[#30363d]" />
