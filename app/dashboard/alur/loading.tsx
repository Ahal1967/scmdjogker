      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 9 }).map((_, i) => (
          <div key={i} className="card space-y-3 p-5">
            <div className="h-10 w-10 rounded-xl bg-gray-200 dark:bg-[#21262d]" />
            <div className="h-4 w-28 rounded bg-gray-200 dark:bg-[#21262d]" />
            <div className="h-3 w-40 rounded bg-gray-200 dark:bg-[#21262d]" />
            <div className="h-6 w-16 rounded bg-gray-200 dark:bg-[#21262d]" />
          </div>
        ))}
      </div>
    </div>
