    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-white px-4 py-10 md:py-16">
      <div className="mx-auto max-w-xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-2 font-display text-2xl font-bold text-black md:text-3xl">Upload Desain</h1>
        ...
        {success ? (
          <div className="card text-center">
            ...
            <p className="font-semibold text-black">Desain berhasil diupload!</p>
          ...
          <form onSubmit={handleSubmit} className="card space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1.5 block">Nomor Pesanan</label>
              <input
                value={noPesanan}
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1.5 block">File Desain</label>
              <div
                onDragOver={(e) => {
                  e.preventDefault();
                  setDragging(true);
              ...
              >
                {preview ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-gray-600">Klik atau drag file desain di sini</p>
