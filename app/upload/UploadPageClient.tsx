  ...
  return (
    ...
    <div className="min-h-screen relative overflow-hidden px-4 py-8 md:py-12">
      <div className="mx-auto max-w-md">
        {/* Sama seperti halaman Lacak Pesanan -- semua bagian yang
            sebelumnya masing-masing punya kotak sendiri sekarang digabung
            jadi SATU kotak besar, mengikuti pola kartu di halaman Login
            (1 bungkus rounded-3xl + shadow biru, dipisah antar-bagian pakai
            garis border-t, bukan kotak terpisah-pisah). Isi & fungsi form
            tetap sama persis. */}
        <div
