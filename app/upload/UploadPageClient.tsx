          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div>
                ...
                {file ? (
                  <div className="flex items-center gap-2.5 rounded-xl border-[1.5px] border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-2.5">
                  ...
                  >
                    <div className="mx-auto mb-2.5 flex h-11 w-11 items-center justify-center rounded-full bg-white dark:bg-gray-800 shadow-md border border-gray-100 dark:border-gray-700">
